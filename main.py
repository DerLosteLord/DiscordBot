...
async def on_message(message):
    ...
    if message.content.startswith("-r/memes"):
        ...
        if y == 13:
            await message.channel.send(file=discord.File('13.jpg'))
        if y == 14:
            await message.channel.send(file=discord.File('14.png'))
        if y == 15:
            await message.channel.send(file=discord.File('15.png'))
        if y == 16:
            await message.channel.send(file=discord.File('16.jpg'))
        if y == 17:
            await message.channel.send(file=discord.File('17.jpg'))
        if y == 18:
            await message.channel.send(file=discord.File('18.jpg'))
        if y == 19:
            await message.channel.send(file=discord.File('19.png'))
        if y == 20:
            await message.channel.send(file=discord.File('20.jpg'))
        if y == 21:
            await message.channel.send(file=discord.File('21.jpg'))


    if message.content.startswith("-kadsenlotto"):
